...
subprocess.call(["/usr/bin/python3", "wc24encrypt.py", "-t", "enc", "-in", "talentzz.dat", "-out", "/opt/nwcs/wbm/talent_pt.ja_JP.enc", "-key", "610B782DAD94000572F66AB3AFB6BDEF", "-rsa", "/opt/key/ranch.pem"])
